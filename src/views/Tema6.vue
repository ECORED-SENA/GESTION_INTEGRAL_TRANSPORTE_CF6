  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 6
      h1 Entrega y recibo de mercancías

    p(data-aos="fade-up") Los almacenes requieren de una coordinación de actividades entre proveedores y clientes, manteniendo constantemente un flujo de información.
    p.mt-4(data-aos="fade-up") Estas actividades se dan para garantizar el recibo o entrega de mercancías, siendo las siguientes las más comunes:
    ...
    .row.mt-5
      ...
      .col-md-6(style="place-self:center")
        ...
        li(data-aos="fade-up" style="list-style:none;")
          .lista-ol--cuadro__vineta
            span 2
          | Revisión del pedido en la zona de entrega, allí se confirma si son los artículos solicitados.
        li(data-aos="fade-up" style="list-style:none;")
          .lista-ol--cuadro__vineta
            span 3
          | Se verifica el número y orden de artículos en el documento; si no se encuentran todos o alguno no está en las condiciones apropiadas, se devuelve el producto y se realiza un acta describiendo lo sucedido.
        li(data-aos="fade-up" style="list-style:none;")
          .lista-ol--cuadro__vineta
            span 4
          | Controlar las mercancías que se reciben por proveedor; al final del recibo, solicitar firma de la persona representante del proveedor o del mismo en dado caso que sea el que surta el producto.
        li(data-aos="fade-up" style="list-style:none;")
          .lista-ol--cuadro__vineta
            span 5
          | Toda la mercancía recibida debe ser colocada en su lugar correcto en el almacén y ser capturada en el sistema.
